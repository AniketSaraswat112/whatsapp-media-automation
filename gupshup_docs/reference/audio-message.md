...
| type          | string | Type of session message | Yes      | audio                                                                                                                                              |
| id            | string | Media Id                | No       | MEDIA\_ID if URL is not provided                                                                                                                   |
| url           | string | URL of the file         | No       | [https://www.buildquickbots.com/whatsapp/media/sample/audio/sample02.mp3](https://www.buildquickbots.com/whatsapp/media/sample/audio/sample02.mp3) |
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Outbound Audio session message API",
    "version": "1.0.0"
  },
  "servers": [
    {
    ...
    "schemas": {
      "Message": {
        ...
        "properties": {
          ...
          "url": {
            "default": "https://www.buildquickbots.com/whatsapp/media/sample/audio/sample02.mp3",
            "type": "string",
