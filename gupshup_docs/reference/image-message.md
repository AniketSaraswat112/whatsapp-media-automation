...
| originalUrl   | string | URL of the image         | No       | [https://picsum.photos/200](https://picsum.photos/200) |
| previewUrl    | string | Preview URL of the image | No       | [https://picsum.photos/200](https://picsum.photos/200) |
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Outbound Image session message API",
    "version": "1.0.0"
  },
  "servers": [
    {
