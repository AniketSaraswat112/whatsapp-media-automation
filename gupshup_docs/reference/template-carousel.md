...
| Field         | Type   | Description                                      | Example                                  |
| ------------- | ------ | ------------------------------------------------ | ---------------------------------------- |
| id            | string | Media ID of the image or video                   | "\<image\_media\_id/video\_media\_id>"   |
| link          | string | Media URL of the image or video                  | "\<image\_media\_url/video\_media\_url>" |
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Sending Carousel Template",
    "contact": {},
    "version": "1.0"
  },
  "servers": [
  ...
  "paths": {
    "/wa/api/v1/template/msg": {
      "post": {
        "operationId": "Sending Carousel Template",
        "parameters": [
          {
            "name": "apikey",
            "in": "header",
            ...
            "application/x-www-form-urlencoded": {
              "schema": {
                ...
                "properties": {
                  ...
                  "template": {
                    "type": "object",
                    "description": "contains template id and list of template parameters in main message bubble and cards in order",
                    "properties": {
                      "id": {
                        "type": "string",
                      ...
                      "params": {
                        "type": "array",
                        "description": "List of template parameters in main message bubble and cards in order",
                        "items": {
                          "type": "string"
                        },
                        "example": [
                  ...
                  "message": {
                    "type": "object",
                    "description": "contains each carousel card's media, either link or id, as well as postback texts (optional)",
                    "properties": {
                      "type": {
                        "type": "string",
                        "description": "Type of message; here it's carousel",
                        "example": "carousel"
                      },
                      "cardHeaderType": {
                        "type": "string",
                        "description": "Type of card header (IMAGE or VIDEO)",
                        "example": "IMAGE"
                      },
                      "cards": {
                        "type": "array",
                        ...
                        "items": {
                          ...
                          "properties": {
                            "id": {
                              "type": "string",
                              "description": "Media ID of the image or video",
                              "example": "<image_media_id/video_media_id>"
                            },
                            "link": {
                              "type": "string",
                              "description": "Media URL of the image or video",
                              "example": "<image_media_url/video_media_url>"
                            },
                            "postbackTexts": {
                              "type": "array",
