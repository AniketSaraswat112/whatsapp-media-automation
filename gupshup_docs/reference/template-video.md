...
| message       | object | Yes      | Contains video details                               | See below for detailed structure |
...
| Field | Type   | Description                        | Example                          |
| ----- | ------ | ---------------------------------- | -------------------------------- |
| type  | string | Type of message                    | video                            |
| video | object | Video object containing id or link | See below for detailed structure |
...
```json
{
  ...
  "paths": {
    "/wa/api/v1/template/msg": {
      "post": {
        "operationId": "Sending Video Template",
        "parameters": [
          {
            "name": "apikey",
            "in": "header",
            ...
            "application/x-www-form-urlencoded": {
              "schema": {
                ...
                "properties": {
                  ...
                  "message": {
                    "type": "object",
                    "description": "object containing video details",
                    "properties": {
                      "type": {
                        "type": "string",
                        "enum": [
