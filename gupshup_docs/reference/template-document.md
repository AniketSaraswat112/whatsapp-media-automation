...
--data-urlencode 'message={"type":"document","document":{"link":"<document_media_url>","id":"<document_media_id>","filename":"<file_name>"}}' \
...
| message       | object | Yes      | Contains document details                            | See below for detailed structure |
...
| Field    | Type   | Description                           | Example                          |
| -------- | ------ | ------------------------------------- | -------------------------------- |
| type     | string | Type of message                       | document                         |
| document | object | Document object containing id or link | See below for detailed structure |
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Sending Document Template",
    "contact": {},
    "version": "1.0"
  },
  "servers": [
  ...
  "paths": {
    "/wa/api/v1/template/msg": {
      "post": {
        "operationId": "Sending Document Template",
        "parameters": [
          {
            "name": "apikey",
            "in": "header",
            ...
            "application/x-www-form-urlencoded": {
              "schema": {
                ...
                "properties": {
                  ...
                  "message": {
                    "type": "object",
                    "description": "object containing document details",
                    "properties": {
                      "type": {
                        "type": "string",
                        "enum": [
