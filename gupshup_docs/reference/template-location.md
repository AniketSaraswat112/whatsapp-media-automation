...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Sending Location Template",
    "contact": {},
    "version": "1.0"
  },
  "servers": [
  ...
  "paths": {
    "/wa/api/v1/template/msg": {
      "post": {
        "operationId": "Sending Location Template",
        "parameters": [
          {
            "name": "apikey",
            "in": "header",
            ...
            "application/x-www-form-urlencoded": {
              "schema": {
                ...
                "properties": {
                  ...
                  "message": {
                    "type": "object",
                    "description": "object containing location details",
                    "properties": {
                      "type": {
                        "type": "string",
                        "enum": [
                      ...
                      "location": {
                        "type": "object",
                        "description": "location object containing details like longitude, latitude, address, name",
                        "properties": {
                          "longitude": {
                            "type": "string",
                          ...
                          "name": {
                            "type": "string",
                            "description": "text that will appear below map",
                            "example": "Miles Morales"
                          },
                          "address": {
                            "type": "string",
                            "description": "address of location that will appear below map",
                            "example": "New York 10019"
                          }
                        }
                      }
                    }
