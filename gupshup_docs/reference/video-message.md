...
--data-urlencode 'message={
  ...
  "previewUrl": "https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file_example_MP4_480_1_5MG.mp4"
}' \
...
--header 'apikey: fg33ssd5oe5jk1iw9nlwmdymofqqnktd' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'source=919355094254' \
...
| type          | string | Type of session message  | Yes      | video                                                                                                                                                                                                     |
| id            | string | Media Id                 | No       | MEDIA\_ID if URL is not provided                                                                                                                                                                          |
| caption       | string | Message caption          | No       | Lorem Ipsum                                                                                                                                                                                               |
| url           | string | URL of the video         | No       | [https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file\_example\_MP4\_480\_1\_5MG.mp4](https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file_example_MP4_480_1_5MG.mp4) |
| previewUrl    | string | Preview URL of the video | No       | [https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file\_example\_MP4\_480\_1\_5MG.mp4](https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file_example_MP4_480_1_5MG.mp4) |
...
```json
{
  "openapi": "3.0.0",
  "info": {
    "title": "Outbound Video session message API",
    "version": "1.0.0"
  },
  "servers": [
    {
      ...
      "Message": {
        ...
        "properties": {
          ...
          "id": {
            ...
            "default": "MEDIA_ID if URL is not proivided"
          },
          "caption": {
            "type": "string",
            "default": "Lorem Ipsum",
          ...
          "url": {
            "default": "https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file_example_MP4_480_1_5MG.mp4",
            "type": "string",
          ...
          "previewUrl": {
            "default": "https://file-examples.com/storage/fe3cb26995666504a8d6180/2017/04/file_example_MP4_480_1_5MG.mp4",
            "type": "string",
            "description": "preview URL of the video"
          }
        },
        "required": [
          "type"
