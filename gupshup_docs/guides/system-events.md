...
In this process, Gupshup will send two webhook events for template\_category\_update.
...
### MM Lite Onboarding Event for Account
...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        The unique identifier of the WhatsApp Business Account (WABA) that was linked.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The Meta Business Manager ID that owns the WABA and associated assets.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        The Meta Ad Account ID that has been linked to the WABA for running click-to-WhatsApp ads or campaigns or Templates in MM Lite
      </td>
    </tr>
  </tbody>
</Table>